...
public interface MonitoringService {
    ...
    List<CarbonCustomPoint> CustomOselectByYearAndQuarter(@Min(2000) @Max(2100) @NotNull(message = "年度不能为空") Integer year, @Pattern(regexp = "Q1|Q2|Q3|Q4|ALL",message = "季度只能是Q1,Q2,Q3,Q4,ALL") String quarter);
}
